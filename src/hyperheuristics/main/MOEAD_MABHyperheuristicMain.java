...
import hyperheuristics.algorithm.moeadfrrmab.MOEAD_DRA_FRRMAB;
...
public class MOEAD_MABHyperheuristicMain {
    ...
    public static void main(String[] args) throws
        ...
        if (args.length == 21) {
            ...
            delta = Double.parseDouble(args[19]);
            selectorType = args[20];
        } else {
        ...
        System.out.println("\tSelector = " + selectorType);
        ...
        for (String problemName : problems) {
            ...
            MOEAD_DRA_FRRMAB algorithm; // The algorithm to use
            ...
            algorithm = new MOEAD_DRA_FRRMAB(problem);
            ...
            algorithm.setInputParameter("w", w);
            ...
            algorithm.setInputParameter("selectorType", selectorType) ;//ucb ucb-v ucb-tunned
            ...
            new File(outputDirectory + "Escolhas_"+problemName+".txt").delete();
