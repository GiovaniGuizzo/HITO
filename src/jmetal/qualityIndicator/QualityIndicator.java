 ...
 * @version 1.0
 *
 * This class provides methods for calculating the values of quality indicators from a solution set. After creating an instance of this class, which requires the file containing the true Pareto of the problem as a parementer, methods such as getHypervolume(), getSpread(), etc. are available
 */
