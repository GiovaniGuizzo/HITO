...
public class MetricsUtil {
   ...
   *
    ...
    /**
     * This method receives a pareto front and two points, one whit maximun values and the other with minimun values allowed, and returns a the normalized pareto front.
     *
