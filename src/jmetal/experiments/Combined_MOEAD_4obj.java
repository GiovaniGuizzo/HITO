...
public class Combined_MOEAD_4obj {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
        ...
        int runsNumber = 30;
        int populationSize = 364;//o segundo mais proximo possivel de 300
        int maxEvaluations = 72800;//o segundo mais proximo possivel de 60mil
        ...
        String context = "_Comb_4obj";
            ...
            for (String filename : softwares) {
                Combined_MOEAD_4obj.createDirectory("resultado/moead_" + nr + "/" + filename + context);
