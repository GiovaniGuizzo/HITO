...
public class SolutionSet implements Serializable {
     ...
     *
     * @param solution The
     * <code>Solution</code> to store
     * @return True If the
     * <code>Solution</code> has been inserted, false otherwise.
     */
     ...
     * @return The
     * <code>Solution</code> at the position i.
    ...
    /**
     * Writes the objective funcion values of the
     * <code>Solution</code> objects into the set in a file.
     *
    ...
    public void printObjectives(double [][] solutions) {

        for (int i = 0; i < solutions.length; i++) {
            double[] ds = solutions[i];
    ...
    /**
     * Deletes the
     * <code>Solution</code> at position i in the set.
     *
    ...
    /**
     * Returns an
     * <code>Iterator</code> to access to the solution set list.
     *
     * @return the
     * <code>Iterator</code>.
     */
    ...
    /**
     * Returns a new
     * <code>SolutionSet</code> which is the result of the union between the
     * current solution set and the one passed as a parameter.
     *
