...
public class IntraSwapMutation extends Mutation {

    //--------------------------------------------------------------------------
    public IntraSwapMutation() {
    }

    //--------------------------------------------------------------------------
    public IntraSwapMutation(Properties properties) {
        this();
    }

    //--------------------------------------------------------------------------
    public void doMutation(double probability, Solution solution) throws JMException {
        mutationIntraCluster(probability, solution);
    }
