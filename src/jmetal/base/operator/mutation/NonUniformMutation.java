...
/**
 * This class implements a non-uniform mutation operator. NOTE: the type of the solutions must be <code>SolutionType_.Real</code>
 */
public class NonUniformMutation extends Mutation {
    ...
    /**
     * actualIteration_ stores the iteration in which the operator is going to be applied
     */
