...
/**
 * This class implements a bit flip mutation operator. NOTE: the operator is applied to binary or integer solutions, considering the whole solution as a single variable.
 */
