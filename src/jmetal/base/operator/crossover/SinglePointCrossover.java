...
/**
 * This class allows to apply a Single Point crossover operator using two parent solutions. NOTE: the operator is applied to binary or integer solutions, considering the whole solution as a single variable.
 */
