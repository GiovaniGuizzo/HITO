 ...
 * @version 1.0 Class representing a HUX crossover operator
 */
...
/**
 * This class allows to apply a HUX crossover operator using two parent solutions. NOTE: the operator is applied to the first variable of the solutions, and the type of the solutions must be binary (e.g., <code>SolutionType_.Binary</code> or <code>SolutionType_.BinaryReal</code>.
 */
