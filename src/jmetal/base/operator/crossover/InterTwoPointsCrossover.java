...
public class InterTwoPointsCrossover extends Crossover {
    ...
    //--------------------------------------------------------------------------
    public InterTwoPointsCrossover() {
        try {
    ...
    //--------------------------------------------------------------------------
    public InterTwoPointsCrossover(Properties properties) {
        this();
    }
    ...
    public Solution[] doCrossover(double probability, Solution parent1, Solution parent2) throws JMException {
        ...
        offspring[0] = interCluster[0];
        offspring[1] = interCluster[1];
