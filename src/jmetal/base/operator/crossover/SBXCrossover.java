...
/**
 * This class allows to apply a SBX crossover operator using two parent solutions. NOTE: the operator is applied to Real solutions, so the type of the solutions must be </code>SolutionType_.Real</code>. NOTE: if you use the default constructor, the value of the etc_c parameter is DEFAULT_INDEX_CROSSOVER. You can change it using the parameter "distributionIndex" before invoking the execute() method -- see lines 196-199
 */
public class SBXCrossover extends Crossover {
    ...
    /**
     * Constructor Create a new SBX crossover operator whit a default index given by <code>DEFAULT_INDEX_CROSSOVER</code>
     */
    public SBXCrossover() {
        try {
