/**
 * PMXCrossover.java Class representing a partially matched (PMX) crossover operator
 *
...
/**
 * This class allows to apply a PMX crossover operator using two parent solutions. NOTE: the operator is applied to the first variable of the solutions, and the type of those variables must be VariableType_.Permutation.
 */
