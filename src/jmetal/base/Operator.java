...
public abstract class Operator implements Serializable {
    ...
    /**
     * Stores the current operator parameters. It is defined as a Map of pairs <<code>String</code>, <code>Object</code>>, and it allow objects to be accessed by their names, which are specified by the string.
     */
     ...
     *
     * @param object This param inherits from Object to allow different kinds of parameters for each operator. For example, a selection operator typically receives a <code>SolutionSet</code> as a parameter, while a mutation operator receives a <code>Solution</code>.
     * @return An object reference. The returned value depends on the operator.
     */
    public abstract Object execute(Object object, Problem problem) throws JMException;
