 ...
 */
public class Genetic_MOEAD_DRA extends Algorithm {
    ...
    public Genetic_MOEAD_DRA(CITO_CAITO problem) {
    ...
    // STEP 1. Initialization
        ...
        do {
            ...
            for (int i = 0; i < order.size(); i++) {
                ...
                Solution[] offSpring = (Solution[]) crossover_.execute(parents, problem_);
